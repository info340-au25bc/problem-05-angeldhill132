...
/* This returned 84, meaning that the function just concatenated the numbers (8 and 4) rather than adding them numerically.
So it completed string addition (concatenation) instead of regular addition*/
...
const compoundIntResult = compoundInterest(1000, 0.05, 15);
console.log(compoundIntResult);
