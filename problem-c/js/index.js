...
lostGames.forEach(function(game) {
  ...
  if (game.home === "UW") {
    ...
    location = opponentName + " at UW";
  } else {
    uwScore = game.opponent_score;
    opponentScore = game.home_score;
    opponentName = game.home;
    location = "UW at " + opponentName;
  }
  console.log(location + ", " + opponentScore + " to " + uwScore);
});
...
const fumbleGames = huskyGames2016.filter(game => game.fumbles > 0);
